...
def _objective(
    ...
    try:
        model_prices = model_module.price_for_calibration(params, S, K, T, r, rights, q=q)
...
def calibrate_model(
    ...
    result = differential_evolution(
        _objective,
        bounds=model.BOUNDS,
        args=(model, S, K, T, r, q, rights, market_prices),
        maxiter=maxiter,
        seed=seed,
        tol=tol,
        polish=True,
    ...
    model_prices = model.price_for_calibration(result.x, S, K, T, r, rights, q=q)
